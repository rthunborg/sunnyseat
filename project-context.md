...
- **Grey map pins are percentage-free.** Shade/cloud/not-sunny pins use the single grey no-number presentation; `CloudObscured` remains diagnostic copy in cards/detail/quick-info where appropriate.
