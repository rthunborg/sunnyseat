...
| `map-selected-time-closed` | Story 12.14 implementation-derived route `/favoriter?_state=map-selected-time-closed&_time=09:00`; dev forcing treats seeded venue id `1` as saved and closed at selected time; active PNG pending maintainer approval before promotion | Story 12.14 implementation-derived route `/favoriter?_state=map-selected-time-closed&_time=09:00`; dev forcing treats seeded venue id `1` as saved and closed at selected time; active PNG pending maintainer approval before promotion |
