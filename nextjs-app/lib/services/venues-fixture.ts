...
export const VENUE_FIXTURE: VenueDataDto[] = [
  ...
  },
  {
    ...
    location: { lat: 57.7035, lng: 11.9520, latitude: 57.7035, longitude: 11.9520 },
    currentSunStatus: 'Sunny',
    skyCondition: 'clear',
    isPartner: false,
    confidence: 88,
  ...
  },
  {
    ...
    neighborhood: 'Inom Vallgraven',
    location: { lat: 57.7080, lng: 11.9655, latitude: 57.7080, longitude: 11.9655 },
    currentSunStatus: 'Sunny',
  ...
  },
  {
    ...
    location: { lat: 57.7000, lng: 11.9710, latitude: 57.7000, longitude: 11.9710 },
  ...
  },
  {
    ...
    neighborhood: 'Haga',
    location: { lat: 57.7115, lng: 11.9605, latitude: 57.7115, longitude: 11.9605 },
    currentSunStatus: 'Partial',
    skyCondition: 'partly-cloudy',
    isPartner: false,
    confidence: 66,
  ...
  },
  {
    ...
    slug: 'skuggans-hus',
    neighborhood: 'Inom Vallgraven',
    location: { lat: 57.7095, lng: 11.9785, latitude: 57.7095, longitude: 11.9785 },
  ...
  },
  {
    ...
    neighborhood: 'Vasastaden',
    location: { lat: 57.7060, lng: 11.9820, latitude: 57.7060, longitude: 11.9820 },
    currentSunStatus: 'Shaded',
    skyCondition: 'overcast',
    isPartner: false,
    confidence: 75,
