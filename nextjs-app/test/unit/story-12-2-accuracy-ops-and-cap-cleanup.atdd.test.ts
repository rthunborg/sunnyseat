...
describe('[12.2 AC3/AC5] feedback evidence migration and generated type contracts', () => {
  test.skip('[P0] migration adds nullable evidence columns with bounded checks and legacy-row compatibility', () => {
    for (const column of [
  ...
  test.skip('[P0] API and Supabase types expose the evidence fields on request, response, insert, and row shapes', () => {
  ...
  test.skip('[P0] persistence writes the evidence fields through the service-role insert path only', () => {
...
describe('[12.2 AC2/AC4/AC5] maintainer agreement aggregation and hash reset reporting', () => {
  test.skip('[P0] maintainer report ranks current-hash disagreements deterministically and isolates invalid venue evidence', () => {
  ...
  test.skip('[P0] aggregation excludes unsure, stale-hash, missing-evidence, and legacy rows from current agreement', () => {
  ...
  test.skip('[P0] agreement mapping vectors use the shared public sunny predicate rather than raw VenueSunStatus', () => {
...
describe('[12.2 AC6/AC7/AC8] coverage-cap bypass retirement and diagnostic confidence', () => {
  test.skip('[P0] SUNNYSEAT_COVERAGE_CAP escape hatch is removed from code, docs, config, and workflows', () => {
  ...
  test.skip('[P0] the internal coverage cap remains fail-closed for missing or unknown coverage', () => {
  ...
  test.skip('[P1] retained confidence is documented as diagnostic or maintainer-only, not public percentage copy', () => {
