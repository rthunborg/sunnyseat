...
describe('[12.1 AC6] honest whole-field unknown at the detail route', () => {
  test('[P0] a real hours-less fixture omits openingHours instead of serializing an empty object', async () => {
  ...
  test('[P0] a known-hours fixture keeps the canonical weekday shape unchanged', async () => {
