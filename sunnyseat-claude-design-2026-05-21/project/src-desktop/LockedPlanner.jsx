// Planner — Soltidsplaneraren side panel.
// Slides in from the right with the day's sun-following route.

function LockedPlanner({ onClose, hour }) {
  return (
...
function PlannerStop({ i, time, name, type, pct, note, active }) {
