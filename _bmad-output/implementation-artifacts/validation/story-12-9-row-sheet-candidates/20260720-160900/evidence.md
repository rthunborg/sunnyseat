> INVALIDATED 2026-07-20: superseded by `20260720-161700`. This intermediate hardened run failed before the measured-overlap assertion was corrected and must not be used for Story 12.9 rebaseline approval.

# Story 12.9 non-authoritative row-sheet candidate captures

Captured 2026-07-20T14:12:02.806Z from the running SunnySeat implementation. These files are **candidate review evidence only**. They do not replace or bless any authoritative reference PNG.
...
- Dev server: started by this script (pid 51460; logs `dev-server.stdout.log`, `dev-server.stderr.log`)
...
- Onboarding: no preseeded localStorage; if the first-visit overlay appears, the script dismisses it through the product skip CTA after hydration so canonical routes do not trigger returning-user hydration mismatches.
...
| mobile | `map-panel-venues` | `mid-drag` | `/?_state=map-panel-venues&_time=14:00&_sheetDrag=mid` | `mobile-map-panel-venues-mid-drag.png` | 780x1688 | 411863 | `5e7151c6d743da9ed59c3c29554811ae7e2e04008c124319c2437c983a4e12b1` | yes | different | `5b168fac021deb8e0b3e9567fa9fa8d4adf4837fee772cceb1f26ade3e98d3c6` | assertion-failed |
...
- Captured: 5
- Failed/assertion-failed: 2
- Canonical refs promoted: 0
- Product errors observed: 0 console errors, 0 page errors, 0 HTTP >=400 responses, 0 failed requests when all targets are captured.
...
Failures require investigation before human review:
- mobile/map-panel-venues/mid-drag: map controls sheet-overlap state: expected controls available outside max sheet, saw {"overlap":"true","ariaHidden":"true","inert":true,"opacity":"0","pointerEvents":"auto","rect":{"top":200,"bottom":308,"height":108}}
...
Assertions:
  ...
  - map controls sheet-overlap state: {"overlap":"false","ariaHidden":null,"inert":false,"opacity":"1","pointerEvents":"auto","rect":{"top":200,"bottom":308,"height":108}}
...
Console/page/request/HTTP observations:
  - console: 8
    ...
    - {"type":"warning","text":"[.WebGL-0x499402e0cc00]GL Driver Message (OpenGL, Performance, GL_CLOSE_PATH_NV, High): GPU stall due to ReadPixels"}
    - {"type":"warning","text":"[.WebGL-0x499402e0cc00]GL Driver Message (OpenGL, Performance, GL_CLOSE_PATH_NV, High): GPU stall due to ReadPixels"}
    - {"type":"warning","text":"[.WebGL-0x499402e0cc00]GL Driver Message (OpenGL, Performance, GL_CLOSE_PATH_NV, High): GPU stall due to ReadPixels"}
    - {"type":"warning","text":"[.WebGL-0x499402e0cc00]GL Driver Message (OpenGL, Performance, GL_CLOSE_PATH_NV, High): GPU stall due to ReadPixels (this message will no longer repeat)"}
...
Assertions:
  ...
  - map controls sheet-overlap state: {"overlap":"true","ariaHidden":"true","inert":true,"opacity":"0","pointerEvents":"auto","rect":{"top":200,"bottom":308,"height":108}}
...
Assertions:
  ...
  - map controls sheet-overlap state: false
...
Assertion failures:
  - map controls sheet-overlap state: expected controls available outside max sheet, saw {"overlap":"true","ariaHidden":"true","inert":true,"opacity":"0","pointerEvents":"auto","rect":{"top":200,"bottom":308,"height":108}}
