# Final story acceptance - September 14

Story15.1 is done after owner-reported clean fourth review and explicit approval. See [final acceptance](FINAL-APPROVAL-2026-09-14.md). Earlier dispositions remain historical. Capacity/A1 gates unchanged; Story15.2 not started.

# Owner acceptance — September 14, 2026

Canonical review gate passed: lint/typecheck and 251 files /2,291 tests. Story15.1 is review, not done; Story15.2 remains backlog/not started. See approval-2026-09-14/EXECUTION.md and canonical-review-gate.log.

Rasmus accepted CD15.1-v1 and A1. See [acceptance record](../../../../planning-artifacts/decisions/epic-15-closure-acceptance-2026-09-14.md). G1 measurement decision lock is satisfied; cold/load/retained-diversity remain unpassed mandatory candidate gates and capacity admission remains held. The original closure package and all historical reports remain unchanged. Current execution is in approval-2026-09-14/; prior indexes are archived in pre-owner-approval-2026-09-14/.

# Consolidated closure — September 14, v1

Current decision: [CD15.1-v1](CLOSURE-DECISION-2026-09-14-v1.md). This maps all criteria/tasks, retains accepted detector/product decisions, proposes complete G1d budgets, and requests explicit amendment A1 for unpassed cold/load/retained-diversity measurements. Current/previous-season rollback retention exceeds the proposed 400MB ceiling under the additive legacy model; admission remains held. Story in-progress; owner decision pending. Prior indexes are preserved in pre-closure-2026-09-14-v1/. Historical text below retains its original disposition.

# Legacy baseline follow-up — September 14

Latest: [legacy storage findings](LEGACY-STORAGE-2026-09-14.md). Actual read-only census and three full row captures identify repeated input payloads as the main legacy storage cost; sql-06 compares exact-value shared reconstruction and bounded coexistence. Synthetic repetition is explicitly labelled. Final G1 acceptance remains open. Earlier reports and their original outcomes are preserved below and in pre-legacy.

# Array-only follow-up — September 12

Latest: [workload results](WORKLOADS-2026-09-12.md) and [accepted-detector matrix](ACCEPTED-MATRIX-2026-09-12.md). Run-18 completes eight local workloads, 161 bounded batches and concurrent reads; run-19 completes all 84 synthetic fixture/date cells. Detector risk remains accepted; numerical production budgets and combined G1 acceptance remain open. Full suite: 251 files /2,291 tests passed. Prior reports are historical and preserved below and in pre-workloads.
