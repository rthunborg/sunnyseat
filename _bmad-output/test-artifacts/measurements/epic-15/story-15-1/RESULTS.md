# Story 15.1 — measurement decision package v5 — Round 3 fixes
...
|---|---:|---:|---:|
| full | 131860 | 61.763 | 61.628 |
| remaining | 21150 | 11.015 | 10.888 |
| rolling | 2430 | 1.083 | 1.11 |
| repair | 500 | 0.226 | 0.218 |
...
Strategy timings and semantic evidence use run-05; main/edge measurements remain run-04, and SQL remains sql-03. Strategy inputs are bound to fixture contents, recorded engine/measurement/package hashes, the season grid, coordinates and the selected main completion artifacts. M04 requires a successful zero-attempt completion, matching source/artifact hashes and all nine percentage/weather cells before any report write.

| Percentage | Weather | Observed pin ARIA | Source-derived detail example (not rendered) |
|---:|---|---|---|
| 25 | likely | Mätplats — ingen direkt sol väntas vid vald tid | Inte soligt vid vald tid |
| 25 | blocked | Mätplats — ingen direkt sol väntas vid vald tid | Inte soligt vid vald tid |
| 25 | unknown | Mätplats — oklart om direkt sol vid vald tid | Vid klar himmel: 25% utan byggnadsskugga |
| 0 | likely | Mätplats — ingen direkt sol väntas vid vald tid | Inte soligt vid vald tid |
| 0 | blocked | Mätplats — ingen direkt sol väntas vid vald tid | Inte soligt vid vald tid |
| 0 | unknown | Mätplats — oklart om direkt sol vid vald tid | Vid klar himmel: 0% utan byggnadsskugga |
| 100 | likely | Mätplats — direkt sol sannolik vid vald tid — 100 procent utan byggnadsskugga | Inte soligt vid vald tid |
| 100 | blocked | Mätplats — ingen direkt sol väntas vid vald tid | Inte soligt vid vald tid |
| 100 | unknown | Mätplats — oklart om direkt sol vid vald tid | Vid klar himmel: 100% utan byggnadsskugga |
